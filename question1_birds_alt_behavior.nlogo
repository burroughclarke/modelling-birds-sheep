;; 1) birds run away from predator at any distance
;; 2) birds only run away if within vision

;; large quantities move in a 'shockwave' ripple, as though the predator was a magnet or anti-gravity

;; https://www.youtube.com/watch?v=V-mCuFYfJdI

turtles-own [
  flockmates         ;; agentset of nearby turtles
  predamates         ;; agentset of nearby predators
  nearest-neighbor   ;; closest one of our flockmates
  nearest-predator   ;; closest predator
]
...
breed [birds bird] ;; define the plural name, then the singular name
...
;  print("new bird...")
  ...
  if any? flockmates [
    ...
    let mylist [ ]
    ask flockmates [ set mylist lput self mylist ]

    ;; undocumented function: __list-to-agentset   source:http://ccl.northwestern.edu/courses/mam-fall-03-source/undocumented.html


    ;; correct!
    set list_length length mylist
    set i list_length - 1

;    print("flockmates.length = ")
;    print(list_length)
...
;      print(i)
      ...
      ;; netlogo crashes if you try to calculate the angle from two turtles in the exact same place


;      print(xcor)
;      print([xcor] of item i mylist)

      if xcor != [xcor] of item i mylist [
        ;; print("not lined up vertically")

         let x-component [sin (towards myself + 180)] of item i mylist
         let y-component [cos (towards myself + 180)] of item i mylist
         let angle-to-flockmate atan x-component y-component
   ;      print("angle to: ")
   ;      print angle-to-flockmate
         set total_angle total_angle + angle-to-flockmate
...
;    print(total_angle)
    ...
    set average_angle total_angle / list_length

;    print("average angle:")
;    print(average_angle)

    ;; turn towards the 'average flockmate angle' e.g. the densest flock of birds it can see'
    turn-towards (average_angle) max-separate-turn
...
true
15
Circle -1184463 true false 49 49 201
Polygon -1184463 true false 60 105 60 45 105 75 60 105
Polygon -1184463 true false 180 45 225 90 240 30 195 60
Circle -1 true true 75 90 60
Circle -1 true true 165 90 60
Polygon -1184463 true false 135 165
Polygon -7500403 true false 120 180 180 180 150 150 120 180
Polygon -1184463 true false 75 150
Line -1184463 false 60 150 15 120
Line -1184463 false 60 150 15 150
Line -1184463 false 60 150 30 180
Line -1184463 false 225 150 270 120
Line -1184463 false 225 150 285 150
Line -1184463 false 225 150 285 180
Circle -16777216 true false 90 105 30
Circle -16777216 true false 180 105 30
Line -16777216 false 180 180 195 180
Line -16777216 false 120 180 105 180
Line -16777216 false 90 165 105 180
Line -16777216 false 210 165 195 180
